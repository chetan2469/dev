...
class _Bride extends State<Bride> {
  bool validUser = false;
  ...
  void initState() {
    ...
    Firestore.instance
      ...
      if (doc.exists) {
        setState(() {
          widget.validUser = true;
          print("________FOUND_______${widget.documentPath}___");
        });
      } else {
        widget.validUser = false;
        print("________NOT FOUND_______${widget.documentPath}___");
      }
    });
  }
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    ...
    return widget.validUser == false
        ? Container(
            padding: EdgeInsets.only(top: 40, left: 10, right: 10),
            child: Text(
              "आगोदर ज्यांच्यासाठी वर किंव्वा वधु शोधात आहात त्यांची माहिती add करा तरच तुम्ही दुसऱ्यांची माहिती पाहू शकता !!",
