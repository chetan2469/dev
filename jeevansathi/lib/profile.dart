...
class ProfileState extends State<Profile> {
    ...
    Firestore.instance
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          nameFieldController.text = doc["name"];
          proffesionFieldController.text = doc["proffesion"];
          educationFieldController.text = doc["education"];
          heightFieldController.text = doc["height"];
          Timestamp dob = doc["dob"];
          _fromDay = dob.toDate();
          _fromTime = TimeOfDay.fromDateTime(_fromDay);

          mob1FieldController.text = doc["mob1"];
          mob2FieldController.text = doc["mob2"];
          birthCityFieldController.text = doc["birthPlace"];
          birthStateFieldController.text = doc["birthState"];
          currentAddressFieldController.text = doc["currentRecidential"];

          infoFieldController.text = doc["moreInfo"];
          expectationsFieldController.text = doc["expectations"];
          //  manglic = doc["manglik"];
          photoUrl = doc["photoUrl"];
          thumbnail = doc["thumbnail"];
          profileCreatedBy = doc["profileCreatedBy"];
          gender = doc["gender"];
          proffesionFieldController.text = doc["proffesion"];
          maritalStatus = doc["maritalStatus"];
          horoscopeMatch = doc["horoscopeMatch"];
          moonshine = doc["moonshine"];
          active = doc["active"];
        });
      } else {
        print(
  ...
  String profileCreatedBy, height = '';
  String name = '',
      thumbnail,
      photoUrl =
  ...
  Future pushToFireStore() async {
    ...
    showModal(context,
        "Profile Updated Successfully !! Will be available within 24 hours...");
  }
  ...
  Future compressImage() async {
    ...
    await Firestore.instance
        .collection('SAK')
        .document(email)
        .updateData({'photoUrl': photoUrl, 'thumbnail': thumbnail});
    ...
    print(photoUrl);
    print(thumbnail);
    showModal(context, 'Image update Successfully...');
  }
  ...
  final List<DropdownMenuItem<String>> _dropDownProfileCreatedBy =
                ...
                RaisedButton(
                  onPressed: () {
                    if (nameValidater &&
                        ...
                        agreement) {
                      onClickSave();
                      showModal(context, 'data is uploading on server');
                    } else {
                      showModal(context, 'please check your details');
                    }
                  },
                  child: Text(
                    'saves',
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextField(
                            ...
                            decoration: InputDecoration(
                              errorText: !nameValidater
                                  ? 'Insert Your Good Name must have 10 characters'
                                  : null,
                        ...
                        SizedBox(height: 20.0),
                        ListTile(
                          leading: Text('Profile Created by'),
                          title: DropdownButton(
                            value: profileCreatedBy,
                            onChanged: ((String str) {
                              setState(() {
                                profileCreatedBy = str;
                              });
                            }),
                            items: _dropDownProfileCreatedBy,
                          ),
                        ),
                        SizedBox(height: 20.0),
                        Container(
